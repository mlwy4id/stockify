...
type ProductRepository interface {
	...
	FindAllArchived(ctx context.Context, userId vo.UserId) ([]*entity.Product, error)
	FindAll(ctx context.Context, userId vo.UserId) ([]*entity.Product, error)
	...
	GetAllStockMovementsWithProduct(ctx context.Context, userId vo.UserId) ([]*entity.StockMovementWithProduct, error)
	GetAllStockMovementsAndDateRangeWithProduct(ctx context.Context, userId vo.UserId, start time.Time, end time.Time) ([]*entity.StockMovementWithProduct, error)
