...
func (r *CategoryRepository) FindByID(ctx context.Context, id vo.CategoryId) (*entity.Category, error) {
...
func (r *CategoryRepository) toEntityFromModel(m *model.CategoryModel) (*entity.Category, error) {
	...
	c := entity.ReconstructCategory(catId, m.Name, m.IsDeleted, m.DeletedAt)
	return &c, nil
}
