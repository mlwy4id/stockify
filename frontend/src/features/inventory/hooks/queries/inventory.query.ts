import { createItem, deleteItem, getAllItems, getItem, updateItem } from '@/shared/lib/api/inventory.api';
import type { UpdateItemRequest } from '@/shared/types/inventory.type';
